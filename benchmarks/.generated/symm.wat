(module
  ...
  (func (;13;) (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 f64 f64)
    global.get 0
    i32.const 16
    i32.sub
    local.tee 13
  ...
  (func (;27;) (type 8) (param i32 i32)
    ...
    i32.add
    global.set 0)
  (func (;28;) (type 3) (param i32 i64 i32) (result i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (elem (;0;) (i32.const 1) 41 33 29 43)

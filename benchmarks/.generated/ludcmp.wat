(module
  ...
  (func (;13;) (type 2) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f64 f64)
    global.get 0
    i32.const 16
    i32.sub
    local.tee 13
    ...
    local.get 11
    local.get 9
    f64.load offset=8192
    local.get 6
    f64.load offset=8404992
    f64.div
    f64.store offset=8192
    local.get 6
    i32.const 8396792
    i32.add
    local.set 4
